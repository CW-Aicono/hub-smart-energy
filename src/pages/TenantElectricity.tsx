...
function TariffsTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Table>
        <TableHeader><TableRow><SortableHead label={t("common.name" as any)} sortKey="name" sort={sort} onToggle={toggle} /><SortableHead label={t("common.location" as any)} sortKey="location" sort={sort} onToggle={toggle} /><TableHead><SortableHead label={T(t, "te.local")} sortKey="local" sort={sort} onToggle={toggle} /> <span className="text-xs text-muted-foreground font-normal">(inkl. MwSt.)</span></TableHead><TableHead><SortableHead label={T(t, "te.grid")} sortKey="grid" sort={sort} onToggle={toggle} /> <span className="text-xs text-muted-foreground font-normal">(inkl. MwSt.)</span></TableHead><TableHead><SortableHead label={T(t, "te.baseFee")} sortKey="base_fee" sort={sort} onToggle={toggle} /> <span className="text-xs text-muted-foreground font-normal">(inkl. MwSt.)</span></TableHead><SortableHead label={T(t, "te.validFrom")} sortKey="valid_from" sort={sort} onToggle={toggle} /><SortableHead label={T(t, "te.validUntilOpt")} sortKey="valid_until" sort={sort} onToggle={toggle} /><TableHead></TableHead></TableRow></TableHeader>
        <TableBody>
