...
function TenantsTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Table>
        <TableHeader><TableRow><TableHead><SortableHead label={t("common.name" as any)} sortKey="name" sort={sort} onToggle={toggle} /></TableHead><TableHead><SortableHead label={T(t, "te.unitLabel")} sortKey="unit" sort={sort} onToggle={toggle} /></TableHead><TableHead><SortableHead label={t("common.email" as any)} sortKey="email" sort={sort} onToggle={toggle} /></TableHead><TableHead>{T(t, "te.meters")}</TableHead><TableHead><SortableHead label={T(t, "te.moveIn")} sortKey="move_in" sort={sort} onToggle={toggle} /></TableHead>{showArchived && <TableHead><SortableHead label={T(t, "te.moveOut")} sortKey="move_out" sort={sort} onToggle={toggle} /></TableHead>}TEMP_STATUS_HEAD<TableHead></TableHead></TableRow></TableHeader>
        <TableBody>
          {sorted.map((te) => (
...
function TariffsTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Table>
        <TableHeader><TableRow><TableHead><SortableHead label={t("common.name" as any)} sortKey="name" sort={sort} onToggle={toggle} /></TableHead><TableHead><SortableHead label={t("common.location" as any)} sortKey="location" sort={sort} onToggle={toggle} /></TableHead><TableHead><SortableHead label={T(t, "te.local")} sortKey="local" sort={sort} onToggle={toggle} /> <span className="text-xs text-muted-foreground font-normal">(inkl. MwSt.)</span></TableHead><TableHead><SortableHead label={T(t, "te.grid")} sortKey="grid" sort={sort} onToggle={toggle} /> <span className="text-xs text-muted-foreground font-normal">(inkl. MwSt.)</span></TableHead><TableHead><SortableHead label={T(t, "te.baseFee")} sortKey="base_fee" sort={sort} onToggle={toggle} /> <span className="text-xs text-muted-foreground font-normal">(inkl. MwSt.)</span></TableHead><TableHead><SortableHead label={T(t, "te.validFrom")} sortKey="valid_from" sort={sort} onToggle={toggle} /></TableHead><TableHead><SortableHead label={T(t, "te.validUntilOpt")} sortKey="valid_until" sort={sort} onToggle={toggle} /></TableHead><TableHead></TableHead></TableRow></TableHeader>
        <TableBody>
...
function InvoicesTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Table>
        <TableHeader><TableRow><TableHead><SortableHead label={T(t, "te.tenant")} sortKey="tenant" sort={sort} onToggle={toggle} /></TableHead><TableHead><SortableHead label={T(t, "te.period")} sortKey="period" sort={sort} onToggle={toggle} /></TableHead><TableHead><SortableHead label={T(t, "te.localCalc")} sortKey="local" sort={sort} onToggle={toggle} /></TableHead><TableHead><SortableHead label={T(t, "te.gridCalc")} sortKey="grid" sort={sort} onToggle={toggle} /></TableHead><TableHead><SortableHead label={T(t, "te.total")} sortKey="total" sort={sort} onToggle={toggle} /></TableHead><TableHead><SortableHead label={T(t, "te.amount")} sortKey="amount" sort={sort} onToggle={toggle} /></TableHead>TEMP_STATUS_HEAD</TableRow></TableHeader>
        <TableBody>
          {sorted.map((inv) => (
            <TableRow key={inv.id}>
