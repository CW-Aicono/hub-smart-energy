...
const SuperAdminInviteDialog = () => {
  ...
  const reset = () => { setEmail(""); setRole("user"); setInviteLink(null); setCopied(false); };
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type="email" placeholder="nutzer@firma.de" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-10" />
              </div>
            </div>
            <div className="space-y-2">
              <Label>Rolle</Label>
