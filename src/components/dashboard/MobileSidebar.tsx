...
import {
  ...
  TrendingUp, Home, Menu, Sparkles, FileText, FileSignature, Share2, BarChart3, CreditCard,
} from "lucide-react";
import {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { to: "/charging/transactions", icon: CreditCard, labelKey: "nav.chargingTransactions" as TranslationKey },
