...
export const saTranslations: SATranslations = {
  ...
  "nav.accounting": { de: "Buchhaltung", en: "Accounting", fr: "Comptabilité", pl: "Księgowość" },
  "nav.billing": { de: "Abrechnung", en: "Billing", fr: "Facturation", pl: "Rozliczenia" },
  "nav.active_licenses": { de: "Aktive Lizenzen", en: "Active Licenses", fr: "Licences actives", pl: "Aktywne licencje" },
  "licenses.subtitle": { de: "Übersicht aller aktiven Mandanten-Lizenzen", en: "Overview of all active tenant licenses", fr: "Aperçu de toutes les licences actives", pl: "Przegląd wszystkich aktywnych licencji" },
  ...
  "tenant_detail.payment_method": { de: "Zahlart", en: "Payment Method", fr: "Mode de paiement", pl: "Metoda płatności" },
  "tenant_detail.invoice": { de: "Rechnung", en: "Invoice", fr: "Facture", pl: "Faktura" },
  "tenant_detail.sepa_direct_debit": { de: "SEPA-Lastschrift", en: "SEPA Direct Debit", fr: "Prélèvement SEPA", pl: "Polecenie zapłaty SEPA" },
  "tenant_detail.sepa_iban": { de: "IBAN", en: "IBAN", fr: "IBAN", pl: "IBAN" },
  "tenant_detail.sepa_bic": { de: "BIC", en: "BIC", fr: "BIC", pl: "BIC" },
  "tenant_detail.sepa_account_holder": { de: "Kontoinhaber", en: "Account Holder", fr: "Titulaire du compte", pl: "Właściciel konta" },
  "tenant_detail.sepa_mandate_ref": { de: "Mandatsreferenz", en: "Mandate Reference", fr: "Référence de mandat", pl: "Referencja mandatu" },
  "tenant_detail.sepa_mandate_date": { de: "Mandatsdatum", en: "Mandate Date", fr: "Date du mandat", pl: "Data mandatu" },
  "tenant_detail.sepa_saved": { de: "Zahlungsdaten gespeichert", en: "Payment data saved", fr: "Données de paiement enregistrées", pl: "Dane płatnicze zapisane" },
  "billing.sepa_export": { de: "SEPA-Sammellastschrift exportieren", en: "Export SEPA Batch Direct Debit", fr: "Exporter le prélèvement SEPA", pl: "Eksportuj polecenie zapłaty SEPA" },
  "billing.sepa_no_debit_tenants": { de: "Keine Mandanten mit SEPA-Lastschrift und offenen Rechnungen", en: "No tenants with SEPA direct debit and open invoices", fr: "Aucun locataire avec prélèvement SEPA et factures ouvertes", pl: "Brak najemców z poleceniem zapłaty SEPA i otwartymi fakturami" },
