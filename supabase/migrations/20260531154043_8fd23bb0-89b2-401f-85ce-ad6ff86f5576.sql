-- Phase 3 Cleanup: Super-Admin Direkt-SELECT-Policies entfernen.
-- Im Impersonation-Modus ist auth.uid() der Tenant-Support-User; Super-Admins
-- brauchen keine direkten SELECT-Policies auf Tenant-Tabellen mehr.
DO $$
DECLARE
  t text;
  tables text[] := ARRAY[
